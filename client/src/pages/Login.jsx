    ...
    >
      <div className="w-full max-w-md p-8 bg-card rounded-2xl border border-border shadow-xl">
        <div className="text-center mb-8">
          ...
          <p className="text-foreground/60 mt-2">Log in to continue your learning journey.</p>
        </div>
        ...
        <p className="text-center mt-6 text-sm text-foreground/60">
          Don't have an account? <button onClick={() => setView('signup')} className="font-bold text-foreground hover:underline">Sign up</button>
        </p>
      </div>
    </motion.div>
  );
